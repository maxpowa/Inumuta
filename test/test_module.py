...
from sopel.test_tools import MockConfig, MockSopel, MockSopelWrapper
...
def test_require_privmsg(bot, trigger, trigger_pm):
    ...
    def mock(bot, trigger, match=None):
        return True
    assert mock(bot, trigger) != True
    assert mock(bot, trigger_pm) == True

    @module.require_privmsg
    def mock_(bot, trigger, match=None):
        return True
    assert mock_(bot, trigger) != True
    assert mock_(bot, trigger_pm) == True
...
def test_require_admin(bot, trigger, trigger_owner):
    ...
    def mock_(bot, trigger, match=None):
        return True
    assert mock_(bot, trigger_owner) == True
